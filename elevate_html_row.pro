pro write_row, tstart, em_start, row_num, folder, wave_times, wave_times_html, num_rows, flare_class, active_region, location, $
                      assoc_wave_time, p_intensity, output_flare_data
...
pro elevate_html_row, fname, folder, outname
  ...
  readcol, fname, obs_tstart, p_intensity, format='A, A'
  ...
  restore, '/Users/eoincarley/Data/elevate_db/lmsal_euv_wave_times.sav'
